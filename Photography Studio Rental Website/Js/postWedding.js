...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const ctaBox = document.querySelector('.footer-cta-inner');
    if(ctaBox) {
        ctaBox.addEventListener('mouseenter', () => {
            ctaBox.style.borderColor = "var(--brand-primary)";
            ctaBox.style.transition = "0.4s ease";
        });
        ctaBox.addEventListener('mouseleave', () => {
            ctaBox.style.borderColor = "var(--border-color)";
        });
    }
  });
