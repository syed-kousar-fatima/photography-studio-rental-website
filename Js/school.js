...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const frame = document.querySelector('.academic-frame');
    const badge = document.querySelector('.floating-achievement-badge');
    ...
    if (frame && badge) {
      frame.addEventListener('mousemove', (e) => {
        ...
        badge.style.transform = `translate(${x * 30}px, ${y * 30}px)`;
      });
